...
const AdminDashboard = () => {
  ...
  const fetchEnquiries = async () => {
    ...
    if (error) {
      toast({
        title: "Error",
        description: "Failed to load enquiries. Ensure you have admin access.",
        variant: "destructive",
      });
    } else {
      setEnquiries(data || []);
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-muted-foreground font-light tracking-wider border-l border-border pl-3">
            ADMIN
          </span>
        </div>
        <div className="flex items-center gap-3">
      ...
      <div className="flex h-[calc(100vh-65px)]">
        {/* Table */}
        <div className={`flex-1 overflow-auto p-6 ${selectedEnquiry ? "hidden lg:block" : ""}`}>
                ...
                <TableBody>
                  {enquiries.map((enquiry) => (
                    ...
                    >
                      ...
                      <TableCell>
                        <Badge variant={statusColor(enquiry.status)} className="text-xs font-light">
                          {enquiry.status}
                        </Badge>
                      </TableCell>
                      <TableCell>
        ...
        {/* Detail Panel */}
        {selectedEnquiry && (
          <div className="w-full lg:w-[400px] border-l border-border p-6 overflow-auto bg-muted/10">
            <div className="flex items-center justify-between mb-6">
              ...
              <Button
                ...
                className="text-xs font-light lg:inline-flex"
              >
                Close
              </Button>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <a href={`mailto:${selectedEnquiry.email}`} className="text-sm font-light text-primary">
              ...
              {selectedEnquiry.phone && (
                <div>
                  ...
                  <a href={`tel:${selectedEnquiry.phone}`} className="text-sm font-light text-primary">
                    {selectedEnquiry.phone}
                  </a>
                </div>
              )}
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    handleStatusChange(selectedEnquiry.id, val)
                  }
                >
