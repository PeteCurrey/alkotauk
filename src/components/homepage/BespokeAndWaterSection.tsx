...
export default function BespokeAndWaterSection() {
  return (
    <section className="bg-[#F8F7F4] text-alkota-black py-24 sm:py-32 overflow-hidden" aria-label="Bespoke Systems & Environmental Compliance">
      <div className="mx-auto max-w-7xl px-6 sm:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center pb-20 sm:pb-28 border-b border-[#E0E0DC]">
          <div className="lg:col-span-6 order-2 lg:order-1">
            ...
            <h2 className="font-barlow-condensed text-4xl sm:text-5xl font-black uppercase italic tracking-tight text-alkota-black leading-none mb-6">
              ENGINEERED AROUND YOUR APPLICATION.
            </h2>
            <p className="font-inter text-base sm:text-lg text-[#555] leading-relaxed mb-6 font-normal">
            ...
            <div className="space-y-2.5 font-ibm-plex-mono text-xs text-[#444] mb-8">
