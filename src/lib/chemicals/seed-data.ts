...
export const RETAIL_PRODUCTS: ChemicalRetailProduct[] = [
  // ── RoadForce Series (Master: TR-407) ──
  {
    ...
    descriptor: 'Professional Vehicle Cleaner',
    ...
    hero_image: '/assets/industries/fleet.png',
    gallery: ['/assets/industries/fleet.png', '/assets/chemicals/roadforce-fleet.jpg'],
    ...
    brand_identity: {
      descriptor: 'Professional Vehicle Cleaner',
      brand_family: 'RoadForce',
      product_promise: 'Built for the dirt ordinary detergents leave behind.',
      product_story_headline: "THIS ISN'T JUST SOAP.",
      product_story_body: "Road film. Grease. Diesel residue. Industrial grime. The things your pressure washer has to fight every day. RoadForce Fleet is engineered around Alkota's American industrial pressure washing heritage to dissolve electrostatically bonded traffic film that ordinary vehicle shampoos leave behind.",
      problem_labels: ['ROAD FILM', 'DIESEL RESIDUE', 'OIL & GREASE', 'WINTER SALT', 'INDUSTRIAL GRIME'],
      application_labels: ['COMMERCIAL HGV', 'HAULAGE FLEETS', 'VANS & LIGHT COMMERCIALS', 'CHASSIS & CABS'],
      hero_image: '/assets/industries/fleet.png',
      lifestyle_images: ['/assets/industries/fleet.png', '/assets/industries/heavy-plant.png'],
      brand_colour_accent: '#FF6900',
      related_product_ids: ['ret-degrease-pro', 'ret-lumaforce-wash-wax', 'ret-alumarestore-pro', 'ret-glossguard-gloss-wax'],
      workflow_steps: [
        { label: '01 PRE-CLEAN', product_name: 'Degrease Pro TR-413', product_slug: 'degrease-pro-rapid-chassis-degreaser', notes: 'Soak chassis, fifth-wheels, and running gear' },
        { label: '02 DEGREASE', product_name: 'GreaseCut DE-703', product_slug: 'greasecut-multi-surface-workshop-degreaser', notes: 'Target heavy engine and axle oil leaks' },
        { label: '03 WASH', product_name: 'RoadForce Fleet TR-407', product_slug: 'roadforce-fleet-heavy-tfr', is_current_product: true, notes: 'Full-bodywork touchless road film breakdown' },
        { label: '04 ALUMINIUM', product_name: 'AlumaRestore TS-602', product_slug: 'alumarestore-aluminium-acid-brightener', notes: 'Brighten oxidised fuel tanks and side guards' },
        { label: '05 RINSE', product_name: 'SpotFree TS-660', product_slug: 'spotfree-sheeting-rinse-aid', notes: 'Accelerate sheeting and spot-free drying' },
        { label: '06 PROTECT', product_name: 'GlossGuard TS-616', product_slug: 'glossguard-hot-spray-sealant-wax', notes: 'Hydrophobic seal and optical gloss enhancement' },
      ],
      ai_content_status: 'human_verified',
    },
  ...
  // ── GreaseCut (Master: DE-703) ──
  {
    ...
    descriptor: 'Heavy Industrial Degreaser',
    ...
    hero_image: '/assets/industries/manufacturing.png',
    gallery: ['/assets/industries/manufacturing.png', '/assets/chemicals/greasecut.jpg'],
    ...
    brand_identity: {
      descriptor: 'Heavy Industrial Degreaser',
      brand_family: 'GreaseCut',
      product_promise: 'Instant hydrocarbon emulsification for workshops and fifth-wheels.',
      product_story_headline: 'OIL AND GREASE DO NOT SURRENDER EASILY.',
      product_story_body: 'Heavy machine oils, hydraulic fluid leaks, and fifth-wheel bitumen form dense polymer chains. GreaseCut penetrates and chemically cracks these hydrocarbons on contact, turning heavy sludge into a free-rinsing emulsion.',
      problem_labels: ['HEAVY GREASE', 'HYDRAULIC OIL', 'BITUMEN & TAR', 'FIFTH-WHEEL SLUDGE'],
      application_labels: ['ENGINE BAYS', 'WORKSHOPS', 'PLANT MACHINERY', 'HEAVY AXLES'],
      hero_image: '/assets/industries/manufacturing.png',
      lifestyle_images: ['/assets/industries/manufacturing.png'],
      brand_colour_accent: '#DC2626',
      related_product_ids: ['ret-roadforce-fleet', 'ret-degrease-pro', 'ret-citrusforce-solvent'],
      ai_content_status: 'human_verified',
    },
    surface_compatibility: [
  ...
  // ── CitrusForce (Master: DE-721) ──
  {
    ...
    descriptor: 'Natural Citrus Tar & Bitumen Solvent',
  ...
  // ── AlumaRestore (Master: TS-602) ──
  {
    ...
    descriptor: 'Professional Aluminium Brightener',
    ...
    hero_image: '/assets/industries/manufacturing.png',
    gallery: ['/assets/industries/manufacturing.png', '/assets/chemicals/alumarestore.jpg'],
    ...
    brand_identity: {
      descriptor: 'Professional Aluminium Brightener',
      brand_family: 'AlumaRestore',
      product_promise: 'Removes milky oxidation, diesel scorch, and restores natural metal lustre.',
      product_story_headline: 'BRING RAW ALUMINIUM BACK TO LIFE.',
      product_story_body: 'Atmospheric corrosion, exhaust smoke, and road salts turn bare aluminium dull, oxidised, and chalky white. AlumaRestore is a specialist acid chemistry that strips oxidised scale layers and neutralises diesel staining in a single rapid application.',
      problem_labels: ['ALUMINIUM OXIDATION', 'DIESEL EXHAUST SCORCH', 'SCALE CORROSION', 'BRAKE DUST'],
      application_labels: ['ALUMINIUM TANKERS', 'TIPPER BODIES', 'TOOLBOXES & WHEELS', 'FABRICATED TRAILERS'],
      hero_image: '/assets/industries/manufacturing.png',
      lifestyle_images: ['/assets/industries/manufacturing.png'],
      brand_colour_accent: '#3B82F6',
      related_product_ids: ['ret-roadforce-fleet', 'ret-lumaforce-wash-wax', 'ret-saltguard-deicer'],
      ai_content_status: 'human_verified',
    },
    surface_compatibility: [
  ...
  // ── MetalForce (Master: TS-610) ──
  {
    ...
    descriptor: 'Phosphoric Acid Rust Wash',
  ...
  // ── ScaleGuard (Master: SD-927) ──
  {
    ...
    descriptor: 'Coil & Water Heating Protectant',
    ...
    hero_image: '/assets/products/420x4.png',
    gallery: ['/assets/products/420x4.png', '/assets/chemicals/scaleguard.jpg'],
    ...
    brand_identity: {
      descriptor: 'Coil & Water Heating Protectant',
      brand_family: 'ScaleGuard',
      product_promise: 'Continuous scale prevention for Schedule 80 heating coils.',
      product_story_headline: 'PROTECT THE HEART OF YOUR HOT WATER WASHER.',
      product_story_body: 'Hard water minerals crystalise inside heating coils under extreme temperatures, restricting flow and leading to premature coil burnout. ScaleGuard sequesters calcium and magnesium before scale can adhere to the steel.',
      problem_labels: ['CALCIUM LIMESCALE', 'COIL RESTRICTION', 'THERMAL EFFICIENCY LOSS', 'MINERAL BUILDUP'],
      application_labels: ['SCHEDULE 80 COILS', 'HOT WATER PRESSURE WASHERS', 'STEAM CLEANERS', 'WASH BAY BOILERS'],
      hero_image: '/assets/products/420x4.png',
      brand_colour_accent: '#10B981',
      related_product_ids: ['ret-coilrestore-descaler', 'ret-roadforce-fleet'],
      ai_content_status: 'human_verified',
    },
    surface_compatibility: [
