...
export default function ResourcesHubPage() {
  const resourceLinks = [
    ...
    { title: 'Case Studies', desc: 'Documentary engineering proof and real-world industrial field stories.', href: '/resources/case-studies', icon: <FileText className="h-8 w-8 text-alkota-orange" /> },
