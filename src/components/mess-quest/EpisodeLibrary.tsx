        ...
        {categories.map((cat) => {
          ...
          return (
            <button
              ...
              className={`px-4 py-2 text-xs font-mono uppercase tracking-wider transition-all cursor-pointer border rounded-[4px] ${
                isActive
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {filteredEpisodes.map((ep, idx) => {
          ...
          return (
            <div
              key={ep.id}
              className={`bg-white border border-[#E0E0DC] flex flex-col justify-between hover:border-alkota-orange transition-all duration-300 group shadow-sm overflow-hidden rounded-[6px] shadow-tactile hover:shadow-tactile-hover transition-shadow ${
            ...
            >
              <div>
                ...
                <div className="relative aspect-[16/10] bg-[#141412] overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 flex items-center gap-2">
                    <span className="text-[10px] font-mono font-bold uppercase tracking-widest bg-alkota-orange text-white px-2.5 py-1 rounded-[3px]">
                      EPISODE {ep.id}
                    </span>
                    <span className="text-[9px] font-mono uppercase tracking-widest bg-black/70 backdrop-blur-sm text-white/90 px-2 py-1 border border-white/20 rounded-[3px]">
                      {ep.categoryFilter}
                    </span>
                  </div>
              ...
              <div className="p-6 sm:p-8 pt-0">
                <Link
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 bg-[#F8F7F4] hover:bg-alkota-orange text-alkota-black hover:text-white px-5 py-3.5 text-xs uppercase tracking-widest transition-colors font-medium border border-[#E0E0DC] hover:border-alkota-orange no-underline rounded-[4px] shadow-button hover:shadow-button-hover btn-tactile"
                >
