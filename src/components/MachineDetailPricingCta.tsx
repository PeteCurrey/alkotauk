    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <button 
          ...
          className="flex-1 flex items-center justify-center gap-3 bg-alkota-orange p-5 text-xs font-black uppercase tracking-[0.25em] text-white hover:bg-orange-600 transition-all shadow-xl shadow-orange-950/20 cursor-pointer"
        >
