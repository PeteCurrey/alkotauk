  ...
  // ── RoadForce Series (Master: TR-407) ──
  {
    ...
    brand_identity: {
      ...
      workflow_steps: [
        ...
        { label: '02 DEGREASE', product_name: 'GreaseCut DE-703', product_slug: 'greasecut-super-duty-degreaser', notes: 'Target heavy engine and axle oil leaks' },
        ...
        { label: '04 ALUMINIUM', product_name: 'AlumaRestore TS-602', product_slug: 'alumarestore-acid-brightener', notes: 'Brighten oxidised fuel tanks and side guards' },
        ...
        { label: '06 PROTECT', product_name: 'GlossGuard TS-616', product_slug: 'glossguard-hot-spray-wax', notes: 'Hydrophobic seal and optical gloss enhancement' },
      ],
