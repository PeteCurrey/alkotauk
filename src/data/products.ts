...
export const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    subtitle: "Break Up Dirt & Soil",
    heroImage: coldWater,
    description:
      "Cost effective tools for dirt and mud removal, cold water pressure washers by Alkota stand up to tough industrial and commercial cleaning jobs. With a range of power sources like gas or electric, we have configurations to accommodate industries including agriculture, plant maintenance, waste management, and more.",
    extendedDescription:
      "We'll match you with a commercial power washing machine that fits your specific needs. We prioritize power and affordability so you can clean with efficiency and not break your budget. From compact portable units to heavy-duty wash bay and wash cannon systems.",
    series: [
      {
        name: "BD Industrial Series",
        image: coldWater,
        specs: {
          "GPM": "2–5",
          "PSI": "Up to 3,000",
          "Power Source": "115V / 230V Electric",
          "Configuration": "Portable or Stationary",
        },
        highlights: ["Electric belt drive", "Tri-plex pump", "Smart timer auto shut-down", "Wall mount or wheel cart options"],
        models: [
          { name: "216BD", gpm: "2", psi: "1,600", powerSource: "115V / 1PH", configuration: "Portable" },
          { name: "311BD", gpm: "3", psi: "1,100", powerSource: "115V / 1PH", configuration: "Portable" },
          { name: "420BD", gpm: "4", psi: "2,000", powerSource: "230V / 1PH", configuration: "Portable" },
          { name: "430BD", gpm: "4", psi: "3,000", powerSource: "230V / 1PH", configuration: "Portable" },
          { name: "530BD", gpm: "5", psi: "3,000", powerSource: "230V / 3PH", configuration: "Stationary" },
        ],
      },
      {
        name: "HHS Hog House Special",
        image: coldWater,
        specs: {
          "GPM": "4–10",
          "PSI": "Up to 4,000",
        ...
        highlights: ["Galvanized frame for corrosion resistance", "18½\" narrow frame fits through doorways", "Belt-driven pump", "Totally enclosed motor"],
        models: [
          { name: "HHS440", gpm: "4", psi: "4,000", powerSource: "230V / 1PH", configuration: "Portable" },
          { name: "HHS530", gpm: "5", psi: "3,000", powerSource: "230V / 1PH", configuration: "Portable" },
          { name: "HHS720", gpm: "7", psi: "2,000", powerSource: "230V / 1PH", configuration: "Portable" },
          { name: "HHS1015", gpm: "10", psi: "1,500", powerSource: "230V / 1PH", configuration: "Portable" },
        ],
      },
      {
        name: "S & SH Series Electric",
        image: coldWater,
        specs: {
          "GPM": "3.7–5",
          "PSI": "Up to 3,000",
        ...
        highlights: ["Heavy duty roll cage frame", "Accepts incoming water up to 180°F", "Belt driven pump", "Winterizing valve"],
        models: [
          { name: "420S", gpm: "3.7", psi: "2,000", powerSource: "230V / 1PH", configuration: "Portable" },
          { name: "430S", gpm: "3.8", psi: "3,000", powerSource: "230V / 1PH", configuration: "Portable" },
          { name: "520S", gpm: "5", psi: "2,000", powerSource: "230V / 1PH", configuration: "Portable" },
          { name: "530S", gpm: "5", psi: "3,000", powerSource: "230V / 3PH", configuration: "Portable" },
        ],
      },
      {
        name: "SG, SM & M Gas/Diesel Series",
        image: coldWater,
        specs: {
          "GPM": "4–8",
          "PSI": "Up to 5,000",
          "Power Source": "Gas & Diesel Engine",
          "Configuration": "Portable / Skid",
        },
        highlights: ["Honda powered options", "Belt driven pump", "Heavy-duty roll cage frame", "Winterizing valve"],
        models: [
          { name: "845SM", gpm: "8", psi: "4,000", powerSource: "Gas / Electric Start", configuration: "Portable" },
          { name: "435S", gpm: "4", psi: "3,500", powerSource: "Gas / Recoil Start", configuration: "Portable" },
          { name: "537S", gpm: "5", psi: "3,500", powerSource: "Diesel / Electric Start", configuration: "Portable" },
          { name: "555M", gpm: "5", psi: "5,000", powerSource: "Gas / Electric Start", configuration: "Skid" },
        ],
      },
      {
        name: "Challenger Cold Water Series",
        image: coldWater,
        specs: {
          "GPM": "2–4",
          "PSI": "Up to 4,000",
          "Power Source": "115V, 230V & Gas Engine",
          "Configuration": "Portable",
        },
        highlights: ["Lightweight aluminum frame", "Solid flat-free tires", "Corrosion-resistant", "Electric or gas engine options"],
        models: [
          { name: "325CSH", gpm: "3", psi: "2,500", powerSource: "Honda GX 200", configuration: "Portable" },
          { name: "445CSH", gpm: "4", psi: "4,000", powerSource: "Honda GX 390", configuration: "Portable" },
          { name: "216CSE", gpm: "2", psi: "1,600", powerSource: "115V / 1PH", configuration: "Portable" },
          { name: "320CSE", gpm: "3", psi: "2,000", powerSource: "230V / 1PH", configuration: "Portable" },
        ],
      },
      {
        name: "219CSE Compact Electric",
        image: coldWater,
        specs: {
          "GPM": "1.7",
          "PSI": "2,000",
        ...
        highlights: ["Ultra-compact design", "115V plug-in operation", "Lightweight & portable"],
        models: [
          { name: "219CSE", gpm: "1.7", psi: "2,000", powerSource: "115V", configuration: "Portable" },
        ],
      },
      {
        ...
        highlights: ["All-weather cabinet design", "UL & CSA certified", "Stainless steel float tank", "Easy-open maintenance cover"],
        models: [
          { name: "420B", gpm: "3.8", psi: "2,000", powerSource: "230V / 1PH", configuration: "Stationary" },
          { name: "430B", gpm: "3.8", psi: "3,000", powerSource: "230V / 1PH", configuration: "Stationary" },
          { name: "530B", gpm: "5", psi: "3,000", powerSource: "230V / 3PH", configuration: "Stationary" },
          { name: "835B", gpm: "8", psi: "3,500", powerSource: "230V / 3PH", configuration: "Stationary" },
          { name: "1030B", gpm: "10", psi: "3,000", powerSource: "230V / 3PH", configuration: "Stationary" },
        ],
      },
      {
        name: "Wash Cannon Series",
        image: coldWater,
        specs: {
          "GPM": "21–25",
          "PSI": "Up to 1,000",
          "Power Source": "230V & Gas Engine",
          "Configuration": "Skid / Trailer Mount",
        },
        highlights: ["High-volume diaphragm pump", "Handles solids up to 3/32\"", "No filtration needed", "Gas or electric options"],
        models: [
          { name: "25500", gpm: "25", psi: "500", powerSource: "230V / 3PH", configuration: "Skid" },
          { name: "25750", gpm: "25", psi: "700", powerSource: "230V / 3PH", configuration: "Skid" },
          { name: "25755", gpm: "25", psi: "700", powerSource: "Honda GX630", configuration: "Skid" },
          { name: "2110", gpm: "21", psi: "1,000", powerSource: "230V / 3PH", configuration: "Skid" },
        ],
      },
      {
        name: "Jetter Series",
        ...
        specs: {
          "GPM": "2–8",
          "PSI": "Up to 4,000",
          "Power Source": "115V & Gas Engine",
          "Configuration": "Portable",
        },
        highlights: ["Sewer & drain cleaning", "Jetter valve & hose reel included", "Electric or gasoline power", "Heavy-duty metal frame"],
        models: [
          { name: "210J", gpm: "2", psi: "1,500", powerSource: "115V / 1PH", configuration: "Portable" },
          { name: "440J", gpm: "4", psi: "4,000", powerSource: "Gas / Recoil Start", configuration: "Portable" },
          { name: "840J", gpm: "8", psi: "4,000", powerSource: "Gas / Electric Start", configuration: "Portable" },
        ],
      },
    ],
  },
