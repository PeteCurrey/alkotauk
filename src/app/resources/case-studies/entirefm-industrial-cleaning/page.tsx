...
export const metadata: Metadata = {
  ...
  description:
    'Discover how EntireFM deploys Alkota hot-water pressure washers for heavy industrial cleaning, factory floor degreasing, and facilities management across the UK.',
  openGraph: {
    title: 'EntireFM Industrial Cleaning Case Study | Alkota UK',
    description:
      'Discover how EntireFM deploys Alkota hot-water pressure washers for heavy industrial cleaning, factory floor degreasing, and facilities management across the UK.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'EntireFM Industrial Cleaning Operations with Alkota Systems',
      },
    ],
  },
  alternates: {
...
export default function EntireFMCaseStudyPage() {
      ...
      <div className="mx-auto max-w-4xl px-6 sm:px-12 py-20 sm:py-28 font-normal">
        ...
        <div className="bg-white p-8 sm:p-12 border border-[#E8E8E4] mb-16">
          <h2 className="font-extralight text-2xl sm:text-3xl uppercase tracking-tight text-alkota-black mb-4">
            The Industrial Facilities Challenge
          </h2>
        ...
        <CaseStudySpecifications
          ...
          title="EntireFM Deployment Parameters"
          subtitle="Operational equipment configuration for industrial facilities management"
        />
        ...
        <CaseStudyRelatedProducts
          ...
          headline="Equipment for Industrial Facilities Management"
        />
      </div>
