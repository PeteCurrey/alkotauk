      ...
      <div className={`px-4 sm:px-8 py-1.5 text-[11px] font-ibm-plex-mono flex items-center justify-between transition-all duration-300 ${
        ...
        <div className="flex items-center gap-4">
          <Link
            ...
            className={`flex items-center gap-1.5 transition-colors uppercase tracking-widest ${
              isLight ? 'text-[#222] hover:text-black' : 'text-[#BBB] hover:text-white'
            }`}
          >
            <ArrowLeft className="w-3 h-3 text-alkota-orange" />
            <span>alkota.co.uk</span>
          </Link>
          <span className={isLight ? 'text-[#DDD] hidden sm:inline' : 'text-[#444] hidden sm:inline'}>|</span>
          <span className={`hidden sm:inline uppercase tracking-widest text-[10px] ${isLight ? 'text-[#777]' : 'text-[#888]'}`}>
        ...
        <div className="flex items-center gap-5">
          <Link
            ...
            className={`flex items-center gap-1.5 text-alkota-orange transition-colors uppercase tracking-widest text-[10px] ${
          ...
          <span className={isLight ? 'text-[#DDD] hidden md:inline' : 'text-[#444] hidden md:inline'}>|</span>
          <Link
            href="/parts-attachments/enquiry"
            className={`transition-colors uppercase tracking-widest text-[10px] hidden md:inline ${
              isLight ? 'text-[#444] hover:text-black' : 'text-[#999] hover:text-white'
            }`}
          >
            Parts Enquiry Desk
          </Link>
      ...
      <div className="px-4 sm:px-8 py-3.5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <Link href="/parts-attachments" className="flex items-center gap-3 no-underline">
            ...
            <div className={`border-l pl-3 py-0.5 hidden sm:block ${isLight ? 'border-black/20' : 'border-white/20'}`}>
              <span className="font-ibm-plex-mono text-[9px] uppercase tracking-[0.2em] text-alkota-orange block font-medium">
                Parts &amp; Tooling
              </span>
              <span className={`text-[11px] font-light uppercase tracking-widest block -mt-0.5 ${
                isLight ? 'text-alkota-black' : 'text-white/90'
              }`}>
                Department
              </span>
            </div>
        ...
        <div className="hidden lg:flex items-center gap-6 flex-1 max-w-2xl mx-6">
          ...
          >
            ...
            <ChevronDown className={`w-3 h-3 transition-transform duration-200 ${
              megaMenuOpen ? (isLight ? 'rotate-180 text-white' : 'rotate-180 text-alkota-black') : 'text-alkota-orange'
            }`} />
          </button>
          ...
          <form onSubmit={handleSearchSubmit} className="relative flex-1">
            ...
            <button
              ...
              className={`absolute right-2.5 top-2.5 transition-colors ${
                isLight ? 'text-[#666] hover:text-alkota-orange' : 'text-[#AAA] hover:text-alkota-orange'
              }`}
            >
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`lg:hidden p-2 transition-colors ${
              isLight ? 'text-alkota-black hover:text-alkota-orange' : 'text-white hover:text-alkota-orange'
            }`}
